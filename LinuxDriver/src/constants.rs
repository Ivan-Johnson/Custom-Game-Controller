...
pub const INPUT_ID_PRODUCT_MERGED_CONTROLLER: u16 = 0x0000;
...
// INPUT_ID_MERGED_CONTROLLER: InputId`. The issue though is that the
// `InputId::new` function isn't const -_-
pub fn get_input_id_merged_controller() -> InputId {
	get_input_id(INPUT_ID_PRODUCT_MERGED_CONTROLLER)
}
